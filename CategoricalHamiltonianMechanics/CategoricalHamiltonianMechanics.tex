...
\begin{multicols}{2}
	...
	\begin{definition}
		...
		\begin{itemize}
			\item its objects are triples \((M,\,\omega,\,H)\), where \((M,\,\omega)\) is a symplectic manifold, and \(H\) is some differentiable real function on \(M\);
	...
	\begin{definition}
		A Hamiltonian theory is a functor from \category{Ham} to \category{EOM}.
	\end{definition}
	Given a Hamiltonian system \((M,\,\omega,\,H)\), a Hamiltonian theory gives us 
\end{multicols}
\end{document}